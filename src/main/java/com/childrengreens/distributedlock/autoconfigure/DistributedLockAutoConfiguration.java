...
public class DistributedLockAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "distributed.lock", name = "provider", havingValue = "redisson",
            matchIfMissing = true)
     ...
     */
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnProperty(prefix = "distributed.lock", name = "provider", havingValue = "zookeeper",
            matchIfMissing = true)
     ...
     */
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnProperty(prefix = "distributed.lock", name = "provider", havingValue = "etcd",
            matchIfMissing = true)
